...
/// @defgroup TRTCCloudDef_cplusplus TRTCCloudDef
...
///由于本地直接调用启动相关的 API， 导致播放进入“播放中”状态
    TRTCAVStatusChangeReasonLocalStarted     = 3,

///由于本地直接调用停止相关的 API， 导致播放进入“已停止”状态
    TRTCAVStatusChangeReasonLocalStopped     = 4,

///由于远端开始（或者继续）发布视频流，导致播放进入“加载中|播放中”状态
    TRTCAVStatusChangeReasonRemoteStarted    = 5,

///由于远端停止（或者暂停）发布视频流，导致播放进入“已停止”状态
